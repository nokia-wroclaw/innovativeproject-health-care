...
class TribeSurveysRes(Resource):
    ...
    def post(self, tribe_id):
        ...
        # Process questions
        for q in questions:
            if all(prop in q for prop in ['id', 'value', 'order']) and bool(q.get('value', None)):
